...
var/global/list/department_IDs = list(FACTION_WAYWARD, FACTION_SKYMARSHAL, FACTION_FOLLOWERS,
 FACTION_TRIBE, FACTION_WASTELANDERS, FACTION_RAIDERS, FACTION_BOS, FACTION_ENCLAVE)
